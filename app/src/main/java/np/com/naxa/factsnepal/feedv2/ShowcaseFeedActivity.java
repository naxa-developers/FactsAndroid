...
public class ShowcaseFeedActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, OnCardItemClickListener<Fact> {

    private RecyclerView recyclerViewFeed;
    private ShowcaseFeedAdapter adapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_showcase_feed);
    ...
    private void setupRecyclerView() {
        adapter = new ShowcaseFeedAdapter(new ArrayList<>(0), this);
