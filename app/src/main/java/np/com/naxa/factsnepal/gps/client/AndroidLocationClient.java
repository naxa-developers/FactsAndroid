...
class AndroidLocationClient
    ...
    private static final String TAG = "AndroidLocationClient";
    ...
    public void setUpdateIntervals(long updateInterval, long fastestUpdateInterval) {
        // Do nothing.
        Log.e(TAG, "Can't set updateInterval on AndroidLocationClient. You should check canSetUpdateIntervals before calling this method." );
    }
