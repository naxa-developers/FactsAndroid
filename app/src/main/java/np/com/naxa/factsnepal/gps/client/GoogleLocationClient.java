package np.com.naxa.factsnepal.gps.client;
...
class GoogleLocationClient
    ...
    private static final String TAG = "GoogleLocationClient";
    ...
    public void setUpdateIntervals(long updateInterval, long fastestUpdateInterval) {
        Log.i(TAG, "GoogleLocationClient setting update intervals: "+ updateInterval+", "+ fastestUpdateInterval);
    ...
    public void resetUpdateIntervals() {
        ...
        Log.i(TAG, "GoogleLocationClient resetting update intervals.");
